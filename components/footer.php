<footer class="footer">
   ...
   <section class="grid">
      ...
      <<img src="images\logo3.ico" alt="Company logo" style="   width: 105px; height: 95px;  margin-left: 236px;">

   </section>

   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>SR Gaming</span> | all rights reserved!</div>
