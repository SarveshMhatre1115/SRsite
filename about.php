...
<div class="about" id="About" style="color: #fff; font-size: 30px; text-shadow: 2px 0px #AA1111; font-family: 'Oxanium', cursive;">
  <div class="contentBx">
...
<iframe width="100%" height="500px"src="img\video-1.mp4"></iframe>


<section class="reviews" style="color: #fff; font-size: 10px; text-shadow: 0px 0px #AA1111; font-family: 'Oxanium', cursive;">
   
   <h1 class="heading" style="color: #fff; font-size: 50px; text-shadow: 2px 2px #AA1111; font-family: 'Oxanium', cursive;">client's reviews</h1>
