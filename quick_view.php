...
<section class="quick-view">
   ...
   <h1 class="heading"style="color: #fff; font-size: 50px; text-shadow: 2px 2px #AA1111; font-family: 'Oxanium', cursive;">quick view</h1>
   ...
   ?>
   <form action="" method="post" class="box"style="color: #fff; font-size: 10px; text-shadow: 2px 0px #AA1111; font-family: 'Oxanium', cursive;">
